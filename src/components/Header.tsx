...
const Header = () => {
  return (
    <header className="mx-auto justify-center lg:px-24 px-6 relative w-full h-24 lg:mb-0 mb-8 lg:grid grid-cols-1 lg:grid-cols-12">
      <div className="text-gray-400 font-medium flex col-span-2 lg:justify-start justify-center items-center mx-auto mt-6 hover:text-black cursor-pointer dark:hover:text-dark-white">
        <a href="/Alltoon">Home</a>
      </div>
