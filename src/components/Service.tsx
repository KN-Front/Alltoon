...
const Service = () => {
  ...
  return (
    <div className="place-self-center">
      ...
      <select
        id="underline_select"
        className="block py-2.5 px-0 w-24 text-sm text-slate-900 dark:text-white dark:bg-zinc-600 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
