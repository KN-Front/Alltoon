                            ...
                            <li>
                                ...
                                <div className="info">
                                    <div className="additional">
                                        {webtoon.additional.adult ? <AdultIcon /> : null}
                                        {webtoon.additional.new ? <NewIcon /> : null}
                                        {webtoon.additional.up ? <UpIcon /> : null}
                                        {webtoon.additional.rest ? <ResetIcon /> : null}
                                    </div>
                                    <a href={webtoon.url}>
